...
View(coordslist)
str(coordslist)
coordslist <- data.frame(coordslist)
coordslist[coordslist$site == 2,9:12] <- coordslist[coordslist$site == 2,9:12]+9
coordslist[coordslist$site == 3,5:8] <- coordslist[coordslist$site == 3,5:8]+9
coordslist[coordslist$site == 4,5:12] <- coordslist[coordslist$site == 4,5:12]+9

write.csv( file = "Plot Coordinates.csv" , coordslist)
